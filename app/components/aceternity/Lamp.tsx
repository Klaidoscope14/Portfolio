...
export function LampDemo() {
  return (
    <LampContainer>
      <div className="relative w-[70vw] h-[40vh]">
        <SparklesCore
          id="tsparticles"
      ...
      <motion.h1
        ...
        className="mb-100 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
      </motion.h1>
    </LampContainer>
  );
